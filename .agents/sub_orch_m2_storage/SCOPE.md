...
|---|---|---|---|---|
| 1 | Add Dependency | Install `@aws-sdk/s3-request-presigner` via pnpm. | None | PLANNED |
...
| 4 | E2E Testing | Write tests for the Server Action (authenticated, role checking, mock/test mode support). | M2.3 | PLANNED |
